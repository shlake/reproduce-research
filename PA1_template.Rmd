...
For this analysis the dataset w/out NA will be used, activityNoNA
...
if (any(weekdays(as.Date(activityNoNA[2000,2])) == weekend)) 
    {
...
Time series plt of 5-minute interval
